...
abstract class AbstractOperationTest {
    ...
    @Test
    void testStreamRandomData() throws InterruptedException {
    ...
    @Test
    void testRoot200() throws InterruptedException {
    ...
    @Test
    void testGET200() throws InterruptedException {
    ...
    @Test
    void testGET400() throws InterruptedException {
        try {
    ...
    @Test
    void testGET400_exchangeStream() throws InterruptedException {
        ...
        response.subscribe(new FlowableSubscriber<HttpResponse<ByteBuffer<?>>>() {
			...
			@Override
			void onNext(HttpResponse<ByteBuffer<?>> r) {
    ...
    @Test
    void testGETJunk200() throws InterruptedException {
        try {
    ...
    @Test
    void testStreamBigResponse() throws InterruptedException {
    ...
    @Test
    void testRawJsonStream() throws InterruptedException {
